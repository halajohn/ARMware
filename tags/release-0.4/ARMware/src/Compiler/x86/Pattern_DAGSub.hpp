...
#ifndef Pattern_DAGSub_hpp
#define Pattern_DAGSub_hpp

#if ENABLE_DYNAMIC_TRANSLATOR

namespace ARMware
{
  namespace Pattern_DAGSub
  {
    inline void
    emit_lir_code(BasicBlock * const curr_bb, DAGNode * const node)
    {
      assert(DAG_SUB == node->kind());
          ...
          case DAG_VAR_CONST:
            {
              ...
              main_lir = curr_bb->append_lir<true>(new LIR(static_cast<LIRSub *>(0),
                                                           tmp,
