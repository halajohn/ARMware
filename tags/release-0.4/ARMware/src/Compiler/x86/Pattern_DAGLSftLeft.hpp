...
#ifndef Pattern_DAGLSftLeft_hpp
#define Pattern_DAGLSftLeft_hpp

#if ENABLE_DYNAMIC_TRANSLATOR

namespace ARMware
{
  namespace Pattern_DAGLSftLeft
  {
    inline LIR *
                         ...
                         Variable * const var3)
    {
      ...
      return curr_bb->append_lir<true>(new LIR(static_cast<LIRLSftLeft *>(0),
                                               var1,
                                               tmp,
                                               var3));
    }
    ...
    {
      assert(DAG_LSFT_LEFT == node->kind());
      ...
      else
      {
        ...
        case DAG_VAR_CONST:
          ...
          {
          case DAG_VAR_CONST:
            assert(!"The 1st operand of the LSFT_LEFT instruction in x86 can't be a constant value.");
            main_lir = 0;
            break;
        ...
        case DAG_VAR_GLOBAL:
          ...
          {
          case DAG_VAR_CONST:
            main_lir = curr_bb->append_lir<true>(new LIR(static_cast<LIRLSftLeft *>(0),
