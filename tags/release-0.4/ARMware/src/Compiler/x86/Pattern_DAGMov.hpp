...
#ifndef Pattern_DAGMov_hpp
#define Pattern_DAGMov_hpp

#if ENABLE_DYNAMIC_TRANSLATOR

namespace ARMware
{
  namespace Pattern_DAGMov
  {
    inline void
    emit_lir_code(BasicBlock * const curr_bb, DAGNode * const node)
    {
      assert(DAG_MOV == node->kind());
      
      // :NOTE: Wei 2005-Mar-09:
      //
      // The out flags of the MOV instruction should _not_ include CARRY & OVERFLOW.
